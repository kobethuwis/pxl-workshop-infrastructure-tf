...
locals {
  ...
  acm_certificate_arn = "arn:aws:acm:eu-west-1:343316312182:certificate/835d061e-fb9a-4ecb-b6b9-d8e63a797533"
  private_subnet_ids  = ["subnet-05b63d38fd78871d0", "subnet-0f66735efcee6e39b"]
  public_subnet_ids   = ["subnet-0cb846b8b2dda6b98", "subnet-0f332ae7d0c44445f"]
